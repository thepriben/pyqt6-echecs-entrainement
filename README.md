...
Ce dépôt GitHub constitue le support du code associé à un article soumis au magazine *Programmez!*. Les détails de publication (numéro et date de parution) seront ajoutés ici ultérieurement.
